...
//
// On a side note, it’s rare that you literally want to increment and return the old value,
// so ++i is often more semantically correct than i++, besides being more efficient.
